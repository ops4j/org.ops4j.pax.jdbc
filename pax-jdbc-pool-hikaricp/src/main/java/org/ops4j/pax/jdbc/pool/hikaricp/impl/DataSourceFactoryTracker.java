...
import org.ops4j.pax.jdbc.pool.hikaricp.impl.ds.HikariPooledDataSourceFactory;
import org.ops4j.pax.jdbc.pool.hikaricp.impl.ds.HikariXAPooledDataSourceFactory;
...
public class DataSourceFactoryTracker extends AbstractDataSourceFactoryTracker {
    ...
    protected DataSourceFactory createPooledDatasourceFactory(DataSourceFactory dsf) {
        if (getTransactionManager() != null) {
            return new HikariXAPooledDataSourceFactory(dsf, tm);
        } else {
            return new HikariPooledDataSourceFactory(dsf);
        }
