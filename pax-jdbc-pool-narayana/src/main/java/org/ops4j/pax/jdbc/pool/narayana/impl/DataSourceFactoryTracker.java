...
import org.ops4j.pax.jdbc.pool.narayana.impl.ds.DbcpPooledDataSourceFactory;
import org.ops4j.pax.jdbc.pool.narayana.impl.ds.DbcpXAPooledDataSourceFactory;
...
public class DataSourceFactoryTracker extends AbstractDataSourceFactoryTracker {
    ...
    protected DataSourceFactory createPooledDatasourceFactory(DataSourceFactory dsf) {
        if (getTransactionManager() != null) {
            return new DbcpXAPooledDataSourceFactory(dsf, context, tm);
        }
        else {
